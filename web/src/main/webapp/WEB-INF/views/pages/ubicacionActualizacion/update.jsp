...
<div class="content">
    <div class="col-12">
        <div class="card">
            <form:form action="editUbicacionActualizacion" autocomplete="off" modelAttribute="updateUbicacionActualizacion" method="post">
                    ...
                    <div class="col-md-11">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <form:input type="hidden" path="id.mapUbicacionId" value='${mapUbicacionActualizacion.id.mapUbicacionId}'/>
                                <form:input type="hidden" path="operacion" name="" value="M"/>
                                <form:input type="hidden" path="id.fechaOperacion" value='${mapUbicacionActualizacion.id.fechaOperacion}'/>
                                <form:input type="hidden" path="fechaAlta" value='${mapUbicacionActualizacion.fechaAlta}' cssClass="form-control" id="street1_id" name="street1" placeholder=""/>
                            </div>
                        </div>
