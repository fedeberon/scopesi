...
<script>
    ...
    $(document).ready(function(){
        ...
        var valueOfSearchStoraged = sessionStorage['poiSectorSearchDataTable'] || '';
        ...
        $('.dataTables_filter input').unbind().keyup(function(e) {
            ...
            if (valueSearchDataTable.length>=1) {
                ...
                sessionStorage['poiSectorSearchDataTable'] = valueSearchDataTable;

            } else {
                dataTableToCompleteList.search('').draw();
                sessionStorage['poiSectorSearchDataTable'] = "";
            }
        });
