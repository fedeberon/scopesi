            ...
            <form:form action="search"  modelAttribute="myWrapper" id="searchModalFilter" name="searchModalFilter">
                ...
                <div class="modal-body row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input name="request.fechaAlta" autocomplete="off"  class="form-control datepicker" placeholder="Seleccione una fecha" style="border:2px solid #a0a0a0;"/>
                    </div>

                    <div class="form-group col-6">
                        <label for="maxResults">Cantidad resultados</label>
                        <select id="select-cantidad" name="request.maxResults" class="form-control" data-live-search="true" title="Seleccione una cantidad">
